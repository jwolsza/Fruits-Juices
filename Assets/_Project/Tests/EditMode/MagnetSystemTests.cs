...
namespace Project.Tests.EditMode
{
    public class MagnetSystemTests
    {
        ...
        public void Magnet_TruckPicksAnyMatchingFruit_RegardlessOfPosition()
        {
            ...
            var assignments = MagnetSystem.AssignFruitsToTrucksAtSlots(grid, new[] { truck }, tickIndex: 0);
        ...
        public void Magnet_MultipleTrucksDifferentColors_EachGetsOwnColor()
        {
            ...
            var assignments = MagnetSystem.AssignFruitsToTrucksAtSlots(
                grid, new[] { truckApple, truckOrange }, tickIndex: 0);
        ...
        public void Magnet_TwoTrucksSameColor_ShareFruits_OnePerTruckPerTick()
        {
            ...
            var assignments = MagnetSystem.AssignFruitsToTrucksAtSlots(grid, new[] { t1, t2 }, tickIndex: 0);
        ...
        [Test]
        public void Magnet_EvenTick_TakesLeftmostMatchingFruit()
        {
            var grid = new FruitGrid(10, 10);
            ...
            Assert.IsFalse(grid.IsCellEmpty(7, 0));
        }

        [Test]
        public void Magnet_OddTick_TakesRightmostMatchingFruit()
        {
            var grid = new FruitGrid(10, 10);
            grid.SetCell(3, 0, FruitType.Apple);
            grid.SetCell(7, 0, FruitType.Apple);
            ...
            var truck = new Truck(1, FruitType.Apple, 100);
            var assignments = MagnetSystem.AssignFruitsToTrucksAtSlots(grid, new[] { truck }, tickIndex: 1);

            Assert.AreEqual(new UnityEngine.Vector2Int(7, 0), assignments[0].GridCellRemoved);
